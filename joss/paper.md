---
title: "Metblocks: An unsupervised method for the analysis of methylation data"
tags: 
    - R
    - Methylation
    - Bioinformatics
...
authors: 
    - name: Christopher Graham Fenton
      orcid: 0000-0002-9960-0967
      affiliation: "1,2"
      corresponding: true
    - name: Ruth H Paulssen
      orcid: 0000-0001-6436-4143
      affiliation: "1,2"
       
affiliations: 
    - name: Clinical Bioinformatics Research Group,  Department of Clinical Medicine, UiT-The Arctic University of Norway, Tromsø, Norway.
      index: 1
    - name: Genomics Support Centre Tromsø (GSCT), Department of Clinical Medicine, UiT-The Arctic University of Norway, Tromsø, Norway.
      index: 2
...
There are several software packages for the identification, visualization, and annotation of differentially methylated regions using sample group data. These include msPipe(@Kim2022), BAT(@Hoffmann2017), bicycle(@Graa2018), GemBS(@Merkel2019),Msuite(@Sun2020),methylseq(@nfcore2024), PiGx(@Pigx2024), snake-Pipes(@Bhardwaj2019), wg-blimp(@Wste2020), RnBeads2(@Muller2019), Bismark(@Krueger2011) and coMET(@Martin2015) among others. Many of these software implementations share algorithms for imputing missing values and finding DMRs. Common algorithms for imputing missing values and region discovery include BSmooth(@Hansen2012), metilene(@Jhling2016), dmrseq(@Korthauer2019), or DSS algorithms(@Park2016). Metblocks hopes to provide complementary information to these well-established algorithms.
...
![Density, overlap and pca of regions .\label{fig1}](pngs/fig1.png)
...
![Example overlaps of regions .\label{fig2}](pngs/fig2.png)
